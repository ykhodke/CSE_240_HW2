...
//can make modifications here as well.
    int sample_sets_num = 14*NUM_CORE;              //ykhodke changes this to 10*NUM_CORES from 20
    if(cfg==1 || cfg == 2){
        //int random_number[20]={46, 102, 257, 406, 510, 630, 772, 880, 981, 1088, 1163, 1206, 1311, 1436, 1543, 1644, 1735, 1810, 1956, 2017};
        int random_number[14] = {5,   71,  292,  394,  417,  587,  605,  621,  990, 1209, 1286, 1490, 1921, 2046};
