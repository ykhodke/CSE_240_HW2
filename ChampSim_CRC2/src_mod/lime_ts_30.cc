...
//
#define SAMPLE_COUNT 128    // LLC_WAYS<<3 unused elsewhere
#define OV_size 128         // FIFO size for history 
int ALIAS_TAB_SIZE;
...
/* This is the code where the number of sampled states are intitiated*/ 

//can make modifications here as well.
    int sample_sets_num = 30*NUM_CORE;              //ykhodke changes this to X*NUM_CORES from 20
    if(cfg==1 || cfg == 2){
        //int random_number[20]={46, 102, 257, 406, 510, 630, 772, 880, 981, 1088, 1163, 1206, 1311, 1436, 1543, 1644, 1735, 1810, 1956, 2017};
        int random_number[30] = {20,   79,   82,  153, 265,  279,  362,  398,  424,  438,  523,  737,  825,  830,  885,  887,  927,  929, 1039, 1207, 1281, 1445, 1506, 1648, 1670, 1731, 1820, 1887, 1965, 1992};
...
uint32_t hash18(uint64_t pc)            //hashing function for PC to 18 bits
{
...
uint64_t hash37(uint64_t tag_addr)      //hashing function for mrmory address to 37 bits
{
