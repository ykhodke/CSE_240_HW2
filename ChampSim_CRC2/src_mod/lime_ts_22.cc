...
//can make modifications here as well.
    int sample_sets_num = 22*NUM_CORE;              //ykhodke changes this to 10*NUM_CORES from 20
    if(cfg==1 || cfg == 2){
        //int random_number[20]={46, 102, 257, 406, 510, 630, 772, 880, 981, 1088, 1163, 1206, 1311, 1436, 1543, 1644, 1735, 1810, 1956, 2017};
        int random_number[22] = {83,  105,  236,  238,  300,  324,  336,  375,  506,  513,  584,  782, 1038, 1309, 1469, 1532, 1592, 1655, 1658, 1863, 1866, 1884};
