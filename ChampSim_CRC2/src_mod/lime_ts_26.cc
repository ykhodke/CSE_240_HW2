...
//can make modifications here as well.
    int sample_sets_num = 26*NUM_CORE;              //ykhodke changes this to 10*NUM_CORES from 20
    if(cfg==1 || cfg == 2){
        //int random_number[20]={46, 102, 257, 406, 510, 630, 772, 880, 981, 1088, 1163, 1206, 1311, 1436, 1543, 1644, 1735, 1810, 1956, 2017};
        int random_number[26] = {40,   46,   56,  355,  367, 516,  523,  646,  747,  787,  950,  995, 1029, 1046, 1140, 1357, 1473, 1530, 1605, 1692, 1788, 1793, 1878, 1950, 1980, 2046};
