...
//can make modifications here as well.
    int sample_sets_num = 18*NUM_CORE;              //ykhodke changes this to 10*NUM_CORES from 20
    if(cfg==1 || cfg == 2){
        //int random_number[20]={46, 102, 257, 406, 510, 630, 772, 880, 981, 1088, 1163, 1206, 1311, 1436, 1543, 1644, 1735, 1810, 1956, 2017};
        int random_number[18] = {0,   37,  380,  484,  544,  653,  684,  941, 1138, 1191, 1273, 1371, 1540, 1617, 1652, 1755, 1765, 1800};
